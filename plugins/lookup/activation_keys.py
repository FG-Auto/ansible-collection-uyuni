...
DOCUMENTATION = r"""
  ...
  short_description: return activation_keys for given system
  description:
      - This lookup returns activation-keys for given system
  options:
    _terms:
...
class LookupModule(LookupBase):
    ...
    def run(self, terms, variables=None, **kwargs):
      ...
      for term in terms:
          ...
          ret.append(api_instance.execute_api_call('system.listActivationKeys', systemID))
