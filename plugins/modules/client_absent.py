...
DOCUMENTATION = '''
---
module: remove_client
short_description: Perform remove of minion 
author:
  - "Klaus Hildebrandt"
'''
import logging
...
def run_module():
    ...
    minions = api_instance.execute_api_call('system.listSystems')
    try:
        minionID = next(filter(lambda m: m['name'] == module.params['minion'] , minions))['id']
        api_instance.execute_api_call('system.deleteSystem', minionID, "FORCE_DELETE")
        result['changed'] = True
