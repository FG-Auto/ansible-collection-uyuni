#!/usr/bin/python3.11
"""
Ansible Module to perform a package refresh on target host
...
def main():
    ...
    Main functions
    """
    argument_spec = dict(**UyuniAPIClient.argument_spec(),
    ...
    actionID = api_instance.execute_api_call("system.schedulePackageRefresh", systemID, 
    ...
    if resWait[0]['failed_count'] > 0:
        result['msg'] = "package_refresh failed"
